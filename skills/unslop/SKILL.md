---
name: unslop
description: Remove common AI writing patterns from narrative prose. Use when drafting or materially editing documentation, explanations, reports, or authorized Jira and pull-request prose; preserve technical meaning and authoritative text.
---
...
Treat all 31 rules below as heuristics, not absolute requirements. Never invent opinions, actors, measurements, events, or sources. Apply the "add soul" guidance only to suitable subjective or user-facing prose. This skill does not itself authorize web lookup; browse only when the underlying task independently requires it.

## Upstream editing guidance

<!-- upstream-guidance-begins -->
