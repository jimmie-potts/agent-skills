...
Do not apply changes unless the user separately asks for fixes. Use `unslop` for
substantial style issues in the verdict without changing evidence, severity, citations, identifiers, or
