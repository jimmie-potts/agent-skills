...
records. Inspect relevant sources; reuse still-current discoveries. Keep a
...
| Tracking and completion | Supported checkpoint operations, required fields, post-merge checks and any release, deployment or human acceptance conditions and owners. |
