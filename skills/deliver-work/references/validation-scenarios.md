...
| A resumed checkpoint has passing local checks at H1, pending CI at H2, no PR yet, and no installation requirement | Use Source, Stage, Plan/spec, Branch, PR, Last verified revision, Evidence, Next checkpoint, and Blocker. Mark absent/inapplicable fields explicitly, retain separate revision-specific gate states, and do not claim H2 is verified because H1 passed locally. |
