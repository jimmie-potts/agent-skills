...
| Approach checkpoint | With a verified Astra parent and a Luna-capable host, give Luna a bounded implementation task. Its first implementation checkpoint proposes an approach with evidence and a recommendation. Dependent edits wait for Astra's response. |
...
- Bounded eligible work selects Luna/medium; open-ended work selects Sol/medium;
  high-impact work selects Sol/high or direct coordination. A stronger explicit
  supported selection persists. Luna/low scouting is never paired.
...
- An explicit Luna requirement cannot silently become Sol. Unknown coordinator
